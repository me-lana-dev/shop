          ...
          <Card style={{ width: "100%" }}>
            ...
            <Formik
              ...
              onSubmit={(values, actions) => {
                ...
                const sortedNewCategory = [...newCategory].sort(
                  (a, b) => a.id - b.id
                );
                editCategory(sortedNewCategory);
                setShowAlert(true);
                setTimeout(() => {
                  setShowAlert(false);
                }, 6000);
            ...
            >
              {(props) => (
                <Form className="form-grid">
                  ...
                  <div
                    className={`form-group ${
                      props.errors.slug && props.touched.slug ? "has-error" : ""
                    }`}
                  >
                    ...
                    {props.errors.slug && props.touched.slug ? (
                      <span className="form-error">{props.errors.slug}</span>
                    ) : null}
                    <Field
                      name="slug"
                      id="slug"
